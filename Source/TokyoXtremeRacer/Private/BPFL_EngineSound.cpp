...
float UBPFL_EngineSound::ComputeSoundUseRpm(const float in_current_rpm, const float in_min_rpm, const float in_max_rpm, const float in_redzone_rpm, const int32 in_player, const float in_over_redzone_rpm_use_rate) {
    return 0.0f;
}
