...
public:
    ...
    FSCarLicensePlate GetNumberByLottery(const int32 in_category, const ECourseSimpleArea in_area, const FName in_number_type, const int32 in_business_use_percent);
